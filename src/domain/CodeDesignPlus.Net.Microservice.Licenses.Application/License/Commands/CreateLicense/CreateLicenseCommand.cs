...
[DtoGenerator]
public record CreateLicenseCommand(Guid Id, string Name, string ShortDescription, string Description, List<ModuleDto> Modules, List<PriceInput> Prices, Icon Icon, string TermsOfService, Dictionary<string, string> Attributes, bool IsActive, bool IsPopular, bool ShowInLandingPage) : IRequest;
