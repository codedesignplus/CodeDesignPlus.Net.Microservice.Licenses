...
[DtoGenerator]
public record CreateLicenseCommand(Guid Id, string Name, string Description, List<ModuleDto> Modules, List<Price> Prices, Guid IdLogo, string TermsOfService, Dictionary<string, string> Attributes, bool IsActive) : IRequest;
