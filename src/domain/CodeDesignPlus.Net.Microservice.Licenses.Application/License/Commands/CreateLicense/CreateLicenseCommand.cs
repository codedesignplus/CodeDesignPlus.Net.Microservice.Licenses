...
[DtoGenerator]
public record CreateLicenseCommand(Guid Id, string Name, string ShortDescription, string Description, List<ModuleDto> Modules, List<Price> Prices, string Icon, string TermsOfService, Dictionary<string, string> Attributes, bool IsActive, bool IsPopular) : IRequest;
