...
[DtoGenerator]
public record PayLicenseCommand(Guid Id, MethodPay MethodPay, Buyer Buyer, Organization Organization) : IRequest;
...
public class Validator : AbstractValidator<PayLicenseCommand>
{
    public Validator()
    {
        ...
        RuleFor(x => x.MethodPay).NotNull().WithMessage("The MethodPay is required.");
