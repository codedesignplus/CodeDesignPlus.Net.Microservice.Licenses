...
) : DomainEvent(aggregateId, eventId, occurredAt, metadata)
{
    ...
    public static LicenseUpdatedDomainEvent Create(Guid aggregateId, string name, string description, List<ModuleEntity> modules, BillingTypeEnum billingType, Currency currency, long price, Dictionary<string, string> attributes, bool isActive)
    {
        return new LicenseUpdatedDomainEvent(aggregateId, name, description, modules, billingType, currency, price, attributes, isActive);
    }
}
