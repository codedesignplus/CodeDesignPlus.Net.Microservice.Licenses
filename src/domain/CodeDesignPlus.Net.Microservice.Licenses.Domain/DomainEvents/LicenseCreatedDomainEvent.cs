...
) : DomainEvent(aggregateId, eventId, occurredAt, metadata)
{
    ...
    public static LicenseCreatedDomainEvent Create(Guid aggregateId, string name, string shortDescription, string description, List<ModuleEntity> modules, List<Price> prices, string icon, string TermsOfService, Dictionary<string, string> attributes, bool isActive, bool isPopular)
    {
