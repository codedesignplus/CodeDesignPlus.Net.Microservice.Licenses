...
builder.Services.AddMongo<CodeDesignPlus.Net.Microservice.Licenses.Infrastructure.Startup>(builder.Configuration);
...
app.MapGrpcService<LicenseGrpcService>().RequireAuthorization();
